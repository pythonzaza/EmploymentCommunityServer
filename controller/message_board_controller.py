...
@message_board_router.post("/list", response_model=MessageOutListModel, name="获取企业留言列表")
...
@message_board_router.post("/delete", response_model=CreateMessageOutModel, name="删除留言")
