...
class CreateArticleModel(BaseModel):
    ...
    title: str = Field(..., description="文章标题", max_length=50)  # 标题
    subtitle: str = Field(..., description="副标题", max_length=100)  # 副标题
    content: str = Field(..., description="正文", max_length=5000)  # 正文
